        ...
        <div>
            <div className="flex font-sans">
                <div className="flex-none w-56 relative">
                    <img src="https://thumbs.dreamstime.com/b/business-dead-line-calender-planner-organization-management-remind-concept-office-desk-cover-lot-documents-92522280.jpg" alt=""
                         className="absolute inset-0 w-full h-full object-cover rounded-lg" loading="lazy"/>
                </div>
                <form className="flex-auto p-6">
                    <div className="flex flex-wrap">
                        <h1 className="flex-auto font-medium text-slate-900 text-color-wh">
                            Kids Jumpsuit
                        </h1>
